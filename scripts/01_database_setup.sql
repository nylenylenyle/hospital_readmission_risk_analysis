...
-- NOTE:
-- Import diabetic_data_raw and ids_mapping_raw before running
-- 02_data_cleaning.sql.


-- 1. DISCHARGE DISPOSITION LOOKUP
...
SELECT COUNT(*) AS discharge_disposition_rows
FROM discharge_disposition_map;

SELECT COUNT(*) AS admission_source_rows
FROM admission_source_map;